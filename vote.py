...
def vote_once(form, value):
    ...
    choose_useragent()
    redirect = {
        "Referer": base_url + str(form) + "/",
        "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8",
        "User-Agent": current_useragent, "Upgrade-Insecure-Requests": "1", "Accept-Encoding": "gzip, deflate, sdch",
    ...
    # request = "https://poll.fm/vote?va=30&pt=0&r=0&p=10224127&a=47004278%2C&o=&t=1758&token=589b233d193c380f0df1e999f3fc62d1&pz=582"

    request = "https://poll.fm/vote?va=" + str(data['at']) + "&pt=0&r=0&p=" + str(form) + "&a=" + str(
       value) + "%2C&o=&t=" + str(data['t']) + "&token=" + str(data['n']) + "&pz=" + str(pz)
    try:
